...
/**
 * Test case for class Tx_Ws_flexslider_Controller_FlexsliderController.
 *
 * @version $Id$
 ...
 */
class Tx_Ws_flexslider_Controller_FlexsliderControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
