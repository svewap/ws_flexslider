 ...
 */
class Tx_WsFlexslider_Domain_Repository_FlexsliderRepository extends Tx_Extbase_Persistence_Repository {
...
if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ws_flexslider/Classes/Domain/Repository/FlexsliderRepository.php"]) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/ws_flexslider/Classes/Domain/Repository/FlexsliderRepository.php"]);
}